...
parser.add_argument("--left_flank" , type=str, required=False, help= "Left flanking sequence")
parser.add_argument("--right_flank" , type=str, required=False, help= "Right flanking sequence")
...
parser.add_argument("--frq" , type=float, required=False, help="freq cut for human codon usage" , default=0.10)
...
for id , ret_set in designer.result:
	length = len(ret_set)
